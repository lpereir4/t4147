...
h2. Primary choices
* Since we are about to implement a TreeSet, we should take advantage of this data structure by make this set sorted.
...
* AVL Tree is the king of balanced tree I'm the most familiar with, it will do the job. 
